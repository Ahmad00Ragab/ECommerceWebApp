						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="assets/confirmation.html">Confirmation</a></li>
								</ul>
							</li>
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="assets/blog.html">Blog</a></li>
									<li class="nav-item"><a class="nav-link" href="assets/single-blog.html">Blog Details</a></li>
								</ul>
							</li>
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
							...
							<li class="nav-item"><a class="nav-link" href="assets/contact.html">Contact</a></li>
						</ul>
