...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            Product productB = new Product("T-shirt", BigDecimal.valueOf(29.99), "Cotton T-shirt", 50, clothing, LocalDateTime.now(), LocalDateTime.now());
            Product productC = new Product("Novel", BigDecimal.valueOf(9.99), "Bestselling novel", 200, books, LocalDateTime.now(), LocalDateTime.now());
